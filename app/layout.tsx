...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "RVplan | RVCC Student Life";
  ...
  return {
    ...
    openGraph: { title, description, type: "website", images: [{ url: `${origin}/og.png`, width: 1200, height: 630, alt: "RVplan club event planner" }] },
