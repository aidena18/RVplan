...
export default function Home() {
  ...
  const drinkCount = Math.ceil(data.attendees * 1.15);
  const snackCount = Math.ceil(data.attendees * 1.1);
          ...
          <section className="formCard">
            ...
            {step === 1 && <>
              ...
              <div className="formGrid">
                ...
                <label className="field"><span>Event type</span><select value={data.eventType} onChange={(e) => update("eventType", e.target.value)}><optgroup label="Club activities"><option>Regular club meeting</option><option>Movie night</option></optgroup><optgroup label="Programs"><option>Formal showcase</option><option>Performance</option><option>Workshop</option><option>Guest speaker</option></optgroup><optgroup label="Fundraising"><option>Bake sale</option><option>Fundraiser</option></optgroup><optgroup label="Trips"><option>Field trip</option><option>Off-campus event</option></optgroup><optgroup label="Celebrations"><option>Holiday celebration</option><option>Cultural celebration</option></optgroup><option>Other</option></select></label>
                {input("date", "date")}
