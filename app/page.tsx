...
export default function Home() {
  ...
  const [coachProfile, setCoachProfile] = useState("criminal-justice");
  ...
  const activeCoachContext = demoClubContexts.find((club) => club.id === coachProfile) || demoClubContexts[0];
  const activeCoachOutput = getDemoCoachOutput(activeCoachContext.id);
