    ...
    <main className={`app view-${view} coach-${coachMode}`}>
      ...
      {view === "home" ? <section className="homeWorkspace" aria-label="RVplan tools">
        ...
        {coachMode === "welcome" ? <div className="coachWelcome">
          ...
          <div className="welcomeMark">◎</div><p className="eyebrow dark">LEADERSHIP COACH</p><h2>Let’s set up your club.</h2><p>Tell us about your club. We’ll build your semester plan.</p>
          ...
          <button className="advisorDemoLink" onClick={() => setCoachMode("advisor")}>Faculty advisor demo →</button>
